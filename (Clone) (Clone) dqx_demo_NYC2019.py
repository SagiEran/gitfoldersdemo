...
"""
input_df = spark.read.format("delta").load(input_location)
...
# to be check and fix to allow the check file yaml load
...
"""
# We already have a check structure from the yml loaded previsously
